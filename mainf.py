...
parser.add_argument('--lr_2', dest='lr_2', type=float, default=0.00001, help='initial learning rate for adam')
...
parser.add_argument('--checkpoint_dir', dest='checkpoint_dir', default='./checkpoint-f', help='models are saved here')
parser.add_argument('--sample_dir', dest='sample_dir', default='./sample-f2', help='sample are saved here')
parser.add_argument('--test_dir', dest='test_dir', default='./test-f', help='test sample are saved here')
parser.add_argument('--L1_lambda', dest='L1_lambda', type=float, default=2.0, help='weight on L1 term in objective')
...
#   CUDA_VISIBLE_DEVICES=0 python mainf.py
#   tensorboard --logdir=./logs-f
#   python mainf.py --phase=test
#   Local1@this hulk