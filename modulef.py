...
from ops import *
from utils import *
# Building conditional discriminator and encoder and decoder
# Defining kinds of loss criterions
def options_define(opt):
...
def generator_encoder(image, reuse=False, name="encoder"):
    ...
    with tf.variable_scope(name):
        ...
        c1 = tf.nn.relu(instance_norm(conv2d(c0, options.gf_dim, 7, 1, padding='VALID', name='g_e1_c'), 'g_e1_bn')) # 256*256
        c2 = tf.nn.relu(instance_norm(conv2d(c1, options.gf_dim*2, 3, 2, name='g_e2_c'), 'g_e2_bn')) #128
...
def generator_decoder(r9,reuse=False, name="Decoder"):
    ...
    with tf.variable_scope(name):
        ...
        # d0 = deconv2d(r12, options.gf_dim * 2, 3, 2, name='g_d0_dc')
